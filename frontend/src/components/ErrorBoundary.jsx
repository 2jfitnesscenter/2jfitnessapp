...
export default class ErrorBoundary extends Component {
  ...
  componentDidCatch(err) { console.error('2J Fitness Center render error:', err) }
  ...
  render() {
    ...
    return (
      <div className="narrow">
        ...
        <Button variant="primary" icon="reset" onClick={() => location.reload()}>{t('Reload 2J Fitness Center')}</Button>
        {active && <>
          <div style={{ height: 8 }} />

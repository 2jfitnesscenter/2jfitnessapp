// 2J Fitness Center icon set — hand-drawn on a 24×24 grid, stroke-based, single weight.
//
...
const P = {
  ...
  send: <path d="M4 12 20.2 3.8l-8 16.4-2.4-6.8L4 12Z" />,
  ...
  users: <><circle cx="8.8" cy="8.6" r="3.3" /><path d="M3.2 20.4a5.8 5.8 0 0 1 11.2 0" /><path d="M15.6 7.2a2.6 2.6 0 1 1 0 5.2" /><path d="M15.6 13.4c2.9.5 4.8 2.8 5.1 6" /></>,

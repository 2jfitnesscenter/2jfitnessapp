/* 2J Fitness Center service worker — runtime caching (works with Vite's hashed asset names).
   Media (img/gif) cache-first; everything else network-first with offline fallback. */
const CACHE = '2jfitness-rt-v1'
...
self.addEventListener('push', e => {
  ...
  e.waitUntil(self.registration.showNotification(data.title || '2J Fitness Center', {
    body: data.body || '',
    icon: 'icon-512.png',
    badge: 'icon-180.png',
